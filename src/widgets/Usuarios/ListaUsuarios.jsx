...
export const ListaUsuarios = () => {
  const { usuarios:paquetes, filtro } = useContext(UserContext);
  sessionStorage.setItem('usuarios', JSON.stringify(paquetes))
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
            <li key={page}>
              <button
                ...
                className={`flex items-center justify-center px-3 py-2 text-sm leading-tight ${page === currentPage
