        ...
        <tr key={n.tracking} className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                <div className="flex items-center">
                    ...
                    {n.estado ? (n.estado) : (n.usuario)}
                </div>
            </td>
            <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{n.plan ? (n.plan) : (n.role)}</td>
            <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{n.peso ? (n.peso) : (n.plan)}</td>
            <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                <div className="flex items-center">
                    ...
                    {n.total ? (n.total) : (n.createdAt)}
                </div>
            </td>
            <td className="px-4 py-2">{n.total ? (n.total) : (n.updateAt ? (n.updateAt) : ('No Editado'))}</td>
            {n.tracking ? (
                <>
